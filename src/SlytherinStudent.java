public class SlytherinStudent extends HogwartsStudent{
    ...
    public void compareSlytherin(SlytherinStudent slytherinStudent){
        ...
        if (ability1>ability2) {
            System.out.println("Слизеринец %s лучше, чем Слизеринец %s:%d VS %d%n", getName(),slytherinStudent.getName(), ability1, ability2);
        } else if (ability2>ability1) {
            System.out.println("Слизеринец %s лучше, чем Слизеринец %s:%d VS %d%n",slytherinStudent.getName(),getName(),ability2,ability1);

        }else {
            System.out.println("Слизеринец %s такой же,как Слизеринец %s:%d VS %d%n",slytherinStudent.getName(),getName(),ability1,ability2);
        }
    }
    @Override
